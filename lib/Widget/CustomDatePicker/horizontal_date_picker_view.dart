import 'package:aquafit_app/Widget/CustomDatePicker/date_item_widget_view.dart';
...
class HorizontalDatePickerWidgetView extends StatefulWidget {
  ///picker start date
  ...
  HorizontalDatePickerWidgetView({
  ...
  @override
  _HorizontalDatePickerWidgetViewState createState() =>
      _HorizontalDatePickerWidgetViewState(
...
class _HorizontalDatePickerWidgetViewState
    extends State<HorizontalDatePickerWidgetView> {
  int _itemCount = 0;
  double _padding = 0.0;
